    ...
    public List<Cell> checkMove(List<Player> p, Board b){
        ...
        for(Player player:p){
            if(player.getCard().getName().compareTo(this.getName()) != 0){
                ...
                if(Math.abs(x) <= 1 && Math.abs(y) <= 1 && b.getCell(player.getWorker1().getRow(),player.getWorker1().getColumn()).getLevel() <= actived.getLevel(b)+1 && !player.getCard().checkBuild(p,b).isEmpty())
                ...
                if(Math.abs(x) <= 1 && Math.abs(y) <= 1 && b.getCell(player.getWorker2().getRow(),player.getWorker2().getColumn()).getLevel() <= actived.getLevel(b)+1 && !player.getCard().checkBuild(p,b).isEmpty())
